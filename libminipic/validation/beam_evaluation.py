...
def validate(evaluate=True, threshold=THRESHOLD):
    ...
    reference_dict = {
        "scalar": {
            "fields": [
                200,
               2.202071603219988e-07, 9.540574176936168e-08, 9.394908687927198e-08, 1.86884411259797e-09, 1.372124655058438e-07, 1.384518800078564e-07
            ],
            "species": [
                [
                    [0, 4392092.0, 0.0009505041795459714],
                    [0, 4392092.0, 1.743852072936683]
                ],
                [
                    [200, 4392092.0, 0.003168493376658438],
                    [200, 4392092.0, 1.743613635021553]
                ],
            ],
        },
        "gamma_spectrum": [
            [
                0.0016843747987616755
            ],
            [
                0.001683617552458559
            ],
        ],
    }
